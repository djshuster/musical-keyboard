...
/**
 *  NOTE: This code was written by Rob Camick, and obtained from
 *  https://tips4java.wordpress.com/2009/05/01/closing-an-application/.
 *  The site says that anyone is "free to use and/or modify and/or
 *  distribute any or all code posted on the Java Tips Weblog without restriction."
 *  (See https://tips4java.wordpress.com/about/)
 *
 ...
 *  can be changed by invoking the setDisposeOnClose() method with "true", in
